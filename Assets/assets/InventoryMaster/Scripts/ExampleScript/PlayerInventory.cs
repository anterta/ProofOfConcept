...
public class PlayerInventory : MonoBehaviour
{
    ...
    public float diminutionHungryStep = 1;
    public float hungryDamageStep = 2;
    public float hungryTreatStep = 1;
    public float hungryLimitDamage = 20;
    public float hungryLimitTreat = 80;
    float currentHealth = 60;
    float currentHungry = 30;
    ...
    void Update()
    {
        currentHungry -= diminutionHungryStep * Time.deltaTime;
        hungrySlider.value = currentHungry / maxHungry;

        if(currentHungry < hungryLimitDamage)
            currentHealth -= hungryDamageStep * Time.deltaTime;
        if(currentHungry > hungryLimitTreat)
            currentHealth += hungryTreatStep * Time.deltaTime;
